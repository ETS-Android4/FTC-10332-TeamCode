...
public class OpModeFinal extends LinearOpMode
{
    public void runOpMode() throws InterruptedException {
        ...
        while (this.opModeIsActive()) {
            final double y = (-this.gamepad1.right_stick_y)*.6;
            final double x = -this.gamepad1.right_stick_x * .7;
            final double rx = this.gamepad1.left_stick_x*.6;
            ...
            final double spinnerPow = 0.38;
            final double spinnerPowRev = -0.38;
            /*
            ...
            */
            final double servoMiddlePos = 0.15;
            if((gamepad1.x || gamepad1.b == true)){
                extServo.setPosition(servoMiddlePos);
                extServo2.setPosition(servoMiddlePos);
            }
            else if ((!this.gamepad1.x && !this.gamepad2.x) || (!this.gamepad1.b && !this.gamepad2.b)) {
                SpinnerMotor.setPower(0.0);
            }
            final double intakePow = 0.5;
            final double intakePowRev = -0.5;
            ...
            final double bucketPos1 = 0.05;
            final double bucketPos2 = 0.45;
            ...
            if (this.gamepad1.dpad_down || this.gamepad2.dpad_down) {
                ...
                slideMotorOne.setPower(0.8);
                slideMotorTwo.setPower(-0.8);
                bucketServo.setPosition(middlePos);
            }
            else {
                if ((this.gamepad1.dpad_down || this.gamepad2.dpad_down) && (this.gamepad1.dpad_up || this.gamepad2.dpad_up)) {
                    continue;
                }
